...
namespace GoogleARCore.Examples.HelloAR {
    ...
    public class ARController : MonoBehaviour {
        ...
        //BOOL TO STOP INSTANTING
        public bool stagePlaced;
        //SCALE FOR TOUCH INSTANTIATE STAGE
        ...
        public void Update() {
            ...
            if (Frame.Raycast(touch.position.x, touch.position.y, raycastFilter, out hit) && !stagePlaced) {
